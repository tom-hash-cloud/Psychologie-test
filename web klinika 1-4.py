...
if 'questions' not in st.session_state:
    st.session_state.questions = {
        ...
        ["Děti s úzkostmi mají intenzivnější obavy z/ze:", ["školních úloh.", "bolístek.", "sportovních výsledků.", "cizích lidí."], 0], # [cite: 1464]
        ["Rituální chování je u malých dětí _______:", ["nepřítomné", "neobvyklé", "běžné", "obtížně pozorovatelné"], 2], # [cite: 1469]
        ["MKN-10 dělí úzkostné poruchy podle:", ["dimenzí", "reakcí", "odpovědi na léčbu", "typického věku nástupu."], 3], # [cite: 1474]
        ...
        ["Děti s GAD se od ostatních liší tím, že:", ["obavy jsou mimo věk", "somatické příznaky", "starosti kvůli drobnostem", "starosti o drobnosti + somatika"], 3], # [cite: 1524]
        ...
        ["______ je nejčastější sekundární diagnózou u úzkostných poruch:", ["Specifická fobie", "Sociální fobie", "OCD", "Generalizovaná úzkostná porucha"], 3], # [cite: 1554]
        ...
        ["Nutkání počítat souvisí s obavou z/ze:", ["symetrie nebo řádu.", "poškození", "kontaminace", "náboženství"], 0], # [cite: 1579]
        ...
        ["Záchvaty paniky se u dospívajících vyskytují u:", ["3-4 %", "8-10 %", "15-20 %", "25-30 %"], 2], # [cite: 1615]
        ...
        ["Dětská psychopatologie odráží chování a _______:", ["symptom", "poruchu", "perspektivu.", "rámec"], 2], # [cite: 1655]
        ...
        "PPP": [
            ["Bulimici se liší od anorektiků tím, že:", ["přejídání/zvracení", "hmotnost v rozmezí 10 % normy.", "projímadla", "tajnůstkaření"], 1], # [cite: 1967]
        ["PPP jsou _______ nejčastější u dospívajících dívek:", ["2.", "3.", "5.", "10."], 1], # [cite: 1972]
        ["Příčiny PPP jsou neúměrně spojeny s vlivy:", ["sociokulturními.", "biologickými", "rodinnými", "psychologickými"], 0], # [cite: 1977]
        ["Co NENÍ pravda o vybíravém jedení?", ["třetina dětí", "častější u dívek", "souvisí s budoucími PPP", "není součástí vývoje."], 3], # [cite: 1982]
        ...
        ["PPP dětí je častější u:", ["dívek", "znevýhodněného prostředí.", "adolescentů", "mentálně postižených"], 1], # [cite: 2022]
        ["Časný nástup PPP u dětí je spojen s:", ["postižením", "důrazem na jídlo", "nedostatečnou péčí.", "metabolickou kontrolou"], 2], # [cite: 2027]
        ["PPP u kojenců má rizikový faktor:", ["temperament", "metabolismus", "psychopatologii", "PPP matky."], 3], # [cite: 2032]
        ["Jedení hmyzu a třísek je:", ["PPP dětství", "ruminace", "neprospívání", "pika."], 3], # [cite: 2037]
        ["Pika se často vyskytuje u:", ["mentálně postižených.", "ADHD", "deprese", "bulimie"], 0], # [cite: 2042]
        ["Pika u zdravých dětí odezní:", ["se zuby", "po nemoci", "při stimulaci.", "s kognicí"], 2], # [cite: 2047]
        ["Pika v 1-2 letech je pravděpodobně z:", ["učení", "hladu", "nedostatku dohledu.", "deprese"], 2], # [cite: 2052]
        ["Neprospívání je váha pod ___ percentilem a/nebo ___ SD:", ["5, 1", "5, 2.", "10, 1", "10, 2"], 1], # [cite: 2057]
        ["Matky neprospívajících dětí jsou:", ["nejisté v citové vazbě.", "mladší", "starší", "méně inteligentní"], 0], # [cite: 2062]
        ["Neprospívání neovlivňuje budoucí:", ["zdraví", "růst", "návyky", "kognitivní fungování."], 3], # [cite: 2067]
        ["Obezita je:", ["onemocnění.", "regulace", "vůle", "duševní porucha"], 0], # [cite: 2072]
        ["Obezita je BMI nad ___ percentilem:", ["60", "70", "80", "95."], 3], # [cite: 2077]
        ["V 90. letech mělo nadváhu kolik amerických dětí?", ["2", "7", "15.", "25"], 2], # [cite: 2082]
        ["Obezita je spojena s obezitou v:", ["kojenci/škola", "kojenci/adolescence", "dětství a dospělosti.", "všude"], 2], # [cite: 2087]
        ["Budoucí obezita dětí v USA a EU:", ["stejná", "poklesne", "vzroste.", "výrazně klesne"], 2], # [cite: 2092]
        ["Vztah obezity a PPP je z:", ["biologie", "posměchu.", "psychiatrie", "ničeho"], 1], # [cite: 2097]
        ["Protein v genetice obezity je:", ["lutein", "peptin", "leptin.", "tyrosin"], 2], # [cite: 2102]
        ["Léčba obezity má klást důraz na:", ["cvičení", "kalorie", "vyhýbání se podnětům", "nesedavý životní styl."], 3], # [cite: 2107]
        ["Dívky kontrolují jídlo jako pokus o:", ["trest rodičů", "zvládnutí stresu a změn dospívání.", "trest sebe", "orální fázi"], 1], # [cite: 2112]
        ["Léčba anorexie dříve:", ["psychoterapie", "hypnóza", "odebrání a nucené krmení.", "rodinná terapie"], 2], # [cite: 2117]
        ["Co NENÍ znakem anorexie?", ["ztráta chuti k jídlu.", "strach z váhy", "popírání podváhy", "odmítání normální váhy"], 0], # [cite: 2122]
        ["MKN-10 dělí anorexii podle:", ["úbytku", "metod omezení příjmu.", "deprese", "rodiny"], 1], # [cite: 2127]
        ["Anorektik přejídající/zvracející má tendenci:", ["jíst stejně", "jíst málo a pravidelně vylučovat.", "zdravé jídlo", "míň důsledně"], 1], # [cite: 2132]
        ["Restriktivní anorektik má tendenci:", ["impulzivita", "obezita v rodině", "nálady", "být kontrolující a rigidní."], 3], # [cite: 2137]
        ["Přejídající/zvracející anorektik má tendenci:", ["kontrola/rigidita", "obese", "méně nálad", "vyšší míra impulzivních poruch."], 3], # [cite: 2142]
        ["Co je pravda o bulimii?", ["anorexie častější", "MKN-10 dělí na projímavý a restriktivní", "třetina vylučuje", "žádné tvrzení."], 3], # [cite: 2147]
        ["Bulimie se dělí na podtypy:", ["přejídání", "zvracení", "projímavý a neprojímavý.", "restriktivní"], 2], # [cite: 2152]
        ["Nejčastější kompenzace v klinice:", ["hlad", "zvracení.", "cvičení", "projímadla"], 1], # [cite: 2157]
        ["Nejčastější kompenzace v běžné populaci:", ["cvičení.", "projímadla", "zvracení", "pilulky"], 0], # [cite: 2162]
        ["Dietně-depresivní bulimičky mají proti čistě dietním:", ["méně poruch", "větší sociální narušení.", "méně komorbidit", "víc anorektických příznaků"], 1], # [cite: 2167]
        ["Zkreslení těla nesouvisí s:", ["pozorností", "pamětí", "interpretací", "percepčními schopnostmi."], 3], # [cite: 2172]
        ["25 % záchvatovitých jedlíků referuje:", ["drogy", "sex", "alkohol", "pokus o sebevraždu."], 3], # [cite: 2177]
        ["BED se od bulimie liší tím, že:", ["nemají ztrátu kontroly", "víc než 1000 kcal", "nemají kompenzační chování.", "nižší sebeúcta"], 2], # [cite: 2182]
        ["Prevalence anorexie u mladých žen je:", ["0,9 %.", "3 %", "7 %", "14 %"], 0], # [cite: 2187]
        ["Co NENÍ pravda o mužích s PPP?", ["stejné klinické rysy", "menší touha po štíhlosti", "větší zaujetí jídlem.", "atletický vzhled"], 2], # [cite: 2192]
        ...
        ["Hilda Bruchová spojovala hladovění u anorexie s:", ["bojem o autonomii a sebeúctu.", "trestáním rodičů", "zabráněním dospívání", "toxiny"], 0], # [cite: 2232]
        ["Arthur Crisp považoval anorexii za poruchu:", ["fobickou vyhýbavou.", "depresivní", "závislostní", "osobnostní"], 0], # [cite: 2237]
        ["Co je NEJMÉNĚ pravděpodobné u anorektika?", ["rigidita", "nedostatek emoční zdrženlivosti.", "známo", "schválení"], 1], # [cite: 2242]
        ["Která porucha je NEJMÉNĚ komorbidní s PPP?", ["deprese", "úzkost", "OCD", "ADHD."], 3], # [cite: 2247]
        ["Spojka mezi depresí a PPP může být:", ["impulzivita", "perfekcionismus.", "hněv", "rigidita"], 1], # [cite: 2252]
        ["Počáteční léčba dětí s anorexií doma je:", ["odebrání", "rodinná terapie.", "farmaka", "individuální terapie"], 1], # [cite: 2257]
        ["Nejúčinnější současná léčba bulimie je:", ["náhled", "rodinná", "farmaka", "CBT."], 3] # [cite: 2262]
    ]
    }
